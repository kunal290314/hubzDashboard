...
function LandingPage() {
  ...
  const [totalHubzUsers, settotalHubzUsers] = useState<any>("0");
  ...
  }, []); // Dependency array includes loginStatus
      ...
      getCreatorWalletActivity(at)
        .then((data: any) => {
          ...
          const receivePercentage =
            Number(receive / Total_Transaction_Values) * 100;
        ...
        >
          ...
          >
            ...
            <Cards
              ...
              svg={<Diamond />}
              value={totalBalance}
              tooltipTitle="Calculated as the current aggregate TON balance held across all unique wallets connected to the Admin's group(s)."
            />
          </Flex>
          <Flex
            justify="center"
          ...
          >
            <Cards
              ...
              svg={<Box />}
              value={meanBalance}
              tooltipTitle="Calculated as the average aggregate TON balance held across all unique wallets connected to the Admin's group(s) over the last 7 days."
            />
            ...
            <Cards
              ...
              tooltipTitle="Calculated as the total number of transactions (can be a receiving or sending transaction) done in the last 7 days by all unique wallets connected to the Admin's group(s), as a percentage of all transactions done by the same wallets (based on onchain records)."
            />
          </Flex>
        </Flex>
      )}
