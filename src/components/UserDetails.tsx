...
function UserDetails({
  ...
  const tontoUSD : any= localStorage.getItem("TON_USD")
  const usdttoUSD : any=  localStorage.getItem("USDT_USD")
                ...
                >
                  ...
                  <Tooltip
                    ...
                    title={
                      ...
                      >
                        Listing all groups where you are designated as an Admin in the Telegram chat settings. The metrics displayed on this dashboard will be an aggregate of all the groups listed.
                      </span>
                    }
                  >
        ...
        <Flex style={{ padding: "34px", flex: 1 }} justify="space-between">
          ...
          <Flex gap={100} justify="flex-start" style={{ flex: 2 }}>
            ...
            <Flex vertical justify="space-between">
              ...
              >
                {`${Number(usdtEarnings).toFixed(2)} USDT (~ ${Number(
                  convertedUSDTEarnings
                )} USD)`}
              </Typography.Title>
            </Flex>
